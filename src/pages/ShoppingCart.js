...
import { decrement, increment, removeFromCart, clearCartProduct } from "../redux/cart/action";
    ...
    return (
        ...
        {cart.length === 0 ? (
                <div className="col-md-12 text-center">
                    ...
                    <Link className="btn btn-outline-dark mt-3 btn" to="/products">Products</Link>
                </div >
            )
            :
                                ...
                                {cart && cart.map(product => (
                                    <tr key={product.id}>
                                        ...
                                        <td className="align-middle" style={{ width: '15%' }}>
                                            <button onClick={() => handleRemoveFormCart(product.id)} className="btn btn-danger btn-sm">delete</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
